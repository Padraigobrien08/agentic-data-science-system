...
must_haves:
  truths:
    - "Sufficiency means every hypothesis reached a terminal status, not that one did — otherwise 33-01's fix strands claims in a new place."
...
Purpose: 33-01 makes a second claim reachable. Without this plan the loop still stops the moment
...
@.planning/phases/33-multi-metric-investigations/33-multi-metric-investigations-01-PLAN.md
@agentic/agent/components.py
@agentic/agent/budget.py
@agentic/domain/enums.py
...
<output>
After completion, create `.planning/phases/33-multi-metric-investigations/33-multi-metric-investigations-02-SUMMARY.md`
</output>
