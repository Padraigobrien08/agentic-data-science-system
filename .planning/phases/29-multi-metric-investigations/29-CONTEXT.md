# Phase 29: Multi-Metric Investigations - Context
...
28-02: `[(['revenue_growth_pct'], 'supported'), (['margin_pct'], 'proposed')]`.

This phase lifts that. It is a product constraint first — multi-part questions are ordinary
analyst questions — and a benchmark constraint second: 28-02 had to drop a planned
...
- `.planning/phases/28-agency-suite-hardening/28-agency-suite-hardening-02-SUMMARY.md` — the
...
- Cached-input pricing tier (from 27-03)
