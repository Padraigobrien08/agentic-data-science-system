...
# Summary 31-02: Model-backed suite execution
...
- `924 passed, 10 skipped` (was 891 + 10 after 31-01; 33 new tests)
- `ruff check .` — clean
...
- The fixture baseline currently scores 100% on all eight properties with zero unstable cases.
  Floors recorded in 31-03 Task 1 should be set just below that, and the saturation risk flagged
  in 31-CONTEXT is live: if models also score near 100%, the cases are not discriminating and
...
31-03: committed per-property floors, the gate test, the benchmark run, the scoreboard document,
