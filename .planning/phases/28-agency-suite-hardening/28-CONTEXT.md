# Phase 28: Agency Suite Hardening - Context
...
Phase 27 measured the agency suite against a real model and found it **saturated**:
...
`AgencyProperty` definitions, or the scoring in `score_case`. Those are sound — phase 27 proved
...
across trials. The 27-02 stability machinery already reports that; treat an unstable hard case
...
### What phase 27 established
- `docs/agent/agency-scoreboard.md` — the saturation finding this phase answers
- `.planning/phases/27-agency-benchmark-under-real-models/27-VERIFICATION.md` — what was verified
...
- The stability machinery from 27-02 already flags a case whose verdict flaps across trials,
...
### Known Risk
- Two of the four guards written in phase 27 were **vacuous on first write** and passed with
...
- `ModelCall` persistence for agentic policy calls — carried from 27-01, independent of this work
