...
# Summary 28-01: Tiering and the discrimination contract
...
reads 93% rather than 100%/0% split. That is exactly the averaging problem 28-03 Task 1 fixes
with `--tier`; the scoreboard must not be published from a mixed row.

## Next

28-02: fixtures and the rest of the hard cases, covering at least three more policy decisions
