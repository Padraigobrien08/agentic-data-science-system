...
Two of the four guards written in phase 31 passed with the bug deliberately restored. Every new
...
`score_case`'s existing scoring blocks. Phase 31 showed these catch real defects; the gap being
...
## Carried From Phase 31 (not addressed here)
