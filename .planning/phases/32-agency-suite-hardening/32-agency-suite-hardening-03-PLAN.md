...
Purpose: this is the question phase 31 could not answer — does a real model reason better than
...
@.planning/phases/32-agency-suite-hardening/32-agency-suite-hardening-02-PLAN.md
@agentic/evaluation/scoreboard.py
@backend/dev/agency_bench.py
@docs/agent/agency-scoreboard.md
...
The phase 31 measurement this one is compared against — `suite_agency_v1`, prompts `1.0.1`,
...
docs/agent/agency-scoreboard.md
.planning/phases/31-agency-benchmark-under-real-models/31-agency-benchmark-under-real-models-03-SUMMARY.md</read_first>
  <behavior>
    - Same conditions as the phase 31 run wherever they are unchanged — 5 trials, same model,
...
from the phase 31 observed cost (that run was $0.26 for 13 cases; scale by the new case count
...
Observed cost is at or under the stated ceiling.</acceptance_criteria>
  ...
  <done>The hardened suite has been measured under conditions comparable to the phase 31 run.</done>
</task>
...
README.md</read_first>
  <behavior>
    ...
    - The phase 31 v1 measurement is preserved for comparison, not overwritten.
...
`docs/agent/agency-scoreboard.md` retains the dated phase 31 v1 measurement for comparison.
...
<output>
After completion, create `.planning/phases/32-agency-suite-hardening/32-agency-suite-hardening-03-SUMMARY.md`
</output>
