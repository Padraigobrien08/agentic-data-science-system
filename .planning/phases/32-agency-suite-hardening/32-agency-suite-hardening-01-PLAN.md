...
every PR. This plan builds that check before the cases arrive, so 32-02 has a bar to clear.
...
agentic/experiments/tools/general_tools.py</read_first>
  <behavior>
    ...
    - The contract is enforced for every hard case, so 32-02 cannot add a case that quietly
...
<output>
After completion, create `.planning/phases/32-agency-suite-hardening/32-agency-suite-hardening-01-SUMMARY.md`
</output>
