...
`tests/test_worker_job_lifecycle.py`, `tests/test_async_run_queue.py`, and `tests/test_run_lifecycle_production.py` assert that prior attempt rows remain terminal instead of returning to `pending`.</acceptance_criteria>
  <verify>
