...
| **Quick run command** | `python3 -m pytest tests/test_worker_job_lifecycle.py tests/test_run_lifecycle_production.py tests/test_async_run_queue.py tests/test_run_lifecycle_api.py tests/test_backend_health.py -q` |
...
- **After every plan wave:** Run `python3 -m pytest tests/test_worker_job_lifecycle.py tests/test_run_lifecycle_production.py tests/test_async_run_queue.py tests/test_run_lifecycle_api.py tests/test_backend_health.py -q`
...
| 02-02 | 02 | 2 | WORK-02 | integration | `python3 -m pytest tests/test_worker_job_lifecycle.py tests/test_async_run_queue.py tests/test_run_lifecycle_api.py tests/test_run_lifecycle_production.py tests/test_worker_attempt_history.py -q` | ❌ W0 | ⬜ pending |
| 02-03 | 03 | 3 | WORK-01, WORK-02 | integration + postgres | `python3 -m pytest tests/test_backend_health.py tests/test_worker_job_lifecycle_postgres.py tests/test_worker_lease_heartbeat.py tests/test_worker_attempt_history.py tests/test_run_lifecycle_api.py -q` | ❌ W0 | ⬜ pending |
