...
Purpose: the benchmark in 27-02 is only meaningful if the prompts under test are inspectable,
...
<output>
After completion, create `.planning/phases/27-agency-benchmark-under-real-models/27-agency-benchmark-under-real-models-01-SUMMARY.md`
</output>
