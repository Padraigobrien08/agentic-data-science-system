...
**Not autonomous.** The caption framing is an open decision in `30-CONTEXT.md`, and the standing
...
@.planning/phases/30-observability-demonstrated/30-observability-demonstrated-01-PLAN.md
@docs/observability.md
@README.md
...
docs/observability.md
.planning/phases/30-observability-demonstrated/30-CONTEXT.md</read_first>
  <behavior>
  ...
  <action>Confirm the caption framing decision from `30-CONTEXT.md` has been answered before
...
<output>
After completion, create `.planning/phases/30-observability-demonstrated/30-observability-demonstrated-02-SUMMARY.md`
</output>
