# Requirements Archive: v1.2 Chat-First Analysis Experience

**Archived:** 2026-04-19
**Status:** SHIPPED

For active planning, start the next milestone and create a fresh `.planning/REQUIREMENTS.md`.
...
- **AUTH-01**: Operators can support richer invitation or team onboarding flows beyond the new capability-aware bootstrap/sign-in guidance

## Out of Scope

| Feature | Reason |
|---------|--------|
| New anomaly-detection models or broader financial-analysis feature work | This milestone was about answer delivery, prompt routing, and runtime reliability, not expanding the analytical model surface |
| Full redesign of every trace, artifact, and evaluation screen | The priority was moving primary reading into chat; deep-dive pages only needed enough simplification to become secondary inspection surfaces |
| Mobile, push notifications, or standalone messaging clients | The immediate problem was the web workspace experience, not expanding to additional client platforms |
| Broader live-validation programs beyond the immediate chat-flow blockers | Those remain valuable, but they are not the fastest path to a coherent chat-first answer experience |
...
*Last updated: 2026-04-19 after archive*
